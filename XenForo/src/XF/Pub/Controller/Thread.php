...
class Thread extends AbstractController
{
	...
	protected function getAvailablePostListSorts(\XF\Entity\Thread $thread): array
	{
		$sortOptions = $this->getThreadRepo()->getDefaultPostListSortOptions();
		$sortOptions += $thread->TypeHandler->getAdditionalPostListSortOptions($thread);
